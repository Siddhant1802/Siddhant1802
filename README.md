...
- **Data Engineering**: Designing scalable pipelines & data platforms  
- **Machine Learning**: Feature engineering, model training & evaluation  
- **Cloud Analytics**: Serverless analytics & data lakes on AWS  
...
### **End-to-End Customer Analytics Platform (AWS)**
**AWS S3 · Glue · Athena · SQL · Power BI**

- Built a **serverless analytics platform** with S3-based data lake architecture  
- Automated schema discovery using **AWS Glue Crawler**
- Created Athena views and Power BI dashboards for churn analysis  

---

### **BedrockChat — AI-Powered Document Assistant**
**AWS Bedrock · LangChain · Python · FAISS**

- Developed a **RAG-based AI system** for semantic document search  
- Integrated LLMs (Claude, Titan) with vector indexing  
- Designed REST APIs with caching & batch inference handling  
...
<p align="center">
  <img
    src="https://capsule-render.vercel.app/api?type=waving&height=120&color=0:2C5364,100:0F2027&section=footer"
  />
</p>
